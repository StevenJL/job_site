...
users = User.create([
  {first_name: 'User', last_name: 'User', email: "user", password_digest: "$2a$10$.PP.FF6.b/VG/zIEaHiQtuZxlXLTUMMcBEzWNQzv1z1wCp4mwl4CG", admin: false},
  ...
  { first_name: "daniel", last_name: "Man", email: "daniel", password_digest: "$2a$10$nm8T0m4MLsiPSB10ct7QT.2LYIoE3XrLgk/6RKAgtPcSFZxnf5h2a", admin: true },
